  ...
  return (
    <div className="flex justify-between items-center gap-7">
      <a href="https://twitter.com" target="_blank" rel="noreferrer">
        {/* target black means open new tab */}
        {/* rel noreffer makes it work properly on older browsers like internet explorer */}
        <Image
      ...
      <a href="https://discord.com" target="_blank" rel="noreferrer">
        <Image
          className={`${isDark ? "brightness-0" : ""} hover:opacity-50`}
        //   brigtness-0 is the only way to make a png white
          alt="discord"
          src={Discord}
          width={20}
          height={20}
